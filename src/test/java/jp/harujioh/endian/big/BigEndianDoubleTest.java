...
/**
 * ビッグエンディアンutilクラスのdouble値テスト
 * 
 * @author rhirata
 */
@FixMethodOrder(MethodSorters.NAME_ASCENDING)
public class BigEndianDoubleTest {
	...
	public void getTest() {
		assertThat( //
				BigEndianUtil.getDouble(new int[] { 0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef }), //
	...
	public void getNotEnoughTest() {
		assertThat( //
				BigEndianUtil.getDouble(new int[] { 0x01, 0x23 }), //
	...
	public void getEnoughTest() {
		assertThat( //
				BigEndianUtil.getDouble(new int[] { 0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef, 0x11 }), //
				is(get(0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef)));
	}
	...
	public void getOffsetNotEnoughLengthTest() {
		assertThat( //
				BigEndianUtil.getDouble(new int[] { 0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef }, 6), //
	...
	public void getOffsetLengthNotEnoughLengthTest() {
		assertThat( //
				BigEndianUtil.getDouble(new int[] { 0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef }, 3, 3), //
				is(get(0x00, 0x00, 0x00, 0x00, 0x00, 0x67, 0x89, 0xab)));
	}
}
